...
```{r}
factor_model_out <- factor_model(data_vignette[1:200,-c(59,102)])
...
```{r}
mosumvar_out <- mosumvar_factor(data_vignette[1:200,-c(59,102)], p = 1, G= 24, nu = .1, method = "Score", alpha = 0.1)
```
